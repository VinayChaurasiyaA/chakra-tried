      ...
      <Stack direction={['column', 'row']} w={'full'} h={'100vh'}>
        <VStack w={'full'}>
          <video
            ...
            style={{ width: '100%' }}
          ></video>
          <VStack alignItems={'flex-start'} w="full" p="2" overflowY={'hidden'}>
            <Heading>Sample 1</Heading>
            <Text>
              Tis quam quasi. Lorem ipsum dolor sit amet, consectetur
              adipisicing elit. Veniam tempore adipisci perspiciatis placeat
              quisquam eum molestias commodi ipsum. Corrupti, unde dolorem
              nostrum autem aperiam consectetur dolor quo! Esse, pariatur
              laboriosam.
            </Text>
          </VStack>
        </VStack>
